...
Net assignment mirrors pcb/mic_array/tools/make_schematic.py's make_arm() (per-mic wiring)
and pcb/multi_fpga/tools/make_schematic_multi_fpga.py's make_cluster() (this cluster's own
Cmod A7-35T DIP header, power connector, LDO) pad-for-pad:
  ...
  pcb/mic_array/tools/make_schematic.py's make_arm() vdd_label parameter and
...
Usage (from project root):
  python pcb/multi_fpga/tools/route_arm_board.py                 # assign nets + set up design rules, save
  python pcb/multi_fpga/tools/route_arm_board.py --dsn out.dsn    # + export Specctra DSN for Freerouting
  python pcb/multi_fpga/tools/route_arm_board.py --ses in.ses     # + import a routed Specctra session back
"""
...
# pcb/multi_fpga/tools/make_schematic_multi_fpga.py's CLUSTER_SPOKE_DIP_PINS uses), not
