...
Usage (from project root):
  python pcb/multi_fpga/tools/route_hub_board.py                 # assign nets + design rules, save
  python pcb/multi_fpga/tools/route_hub_board.py --dsn out.dsn    # + export Specctra DSN for Freerouting
  python pcb/multi_fpga/tools/route_hub_board.py --ses in.ses     # + import a routed Specctra session back
  python pcb/multi_fpga/tools/route_hub_board.py --zones          # + add/fill a GND pour (F.Cu)
"""
