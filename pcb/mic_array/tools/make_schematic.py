...
Usage (from project root):
  python pcb/mic_array/tools/make_schematic.py
"""
...
TOOLS_DIR = os.path.dirname(os.path.abspath(__file__))  # pcb/mic_array/tools
OUTDIR  = os.path.dirname(TOOLS_DIR)                     # pcb/mic_array
